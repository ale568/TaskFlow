...
describe('TimeSheetController', () => {
    ...
    beforeEach(() => {
        ...
        mockEntries = [
            new TimeEntry(1, 'Project1', 'Task1', '2025-02-10', 120),
            new TimeEntry(2, 'Project2', 'Task2', '2025-02-11', 90),
            new TimeEntry(3, 'Project1', 'Task3', '2025-02-11', 50)
        ];
    });

    test('It should add a time entry', () => {
        const newEntry = new TimeEntry(4, 'Project3', 'Task4', '2025-02-13', 40);
